 ...
 */
void ArbolFrecuencias::insert(Mat image, String*frameIn) {
    root = insert(root, image, frameIn);
...
BinarySearchTreeNode* ArbolFrecuencias::insert(BinarySearchTreeNode* node, Mat image, String *frameIn) {
